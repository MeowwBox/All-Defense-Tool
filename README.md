...
| Strix 是自主运行的 AI 代理，它们的行为就像真正的黑客一样——动态运行您的代码，发现漏洞，并通过实际的概念验证进行验证。 | https://github.com/usestrix/strix | 2026-08-28 |
...
| 项目简介 | 项目地址 | 最近更新 |
| ------------------------------------------------------------ | --------------------------------------------- | --- |
| 单兵作战武器库，你值得拥有 | https://github.com/yaklang/yakit | 2026-08-29 |
...
| reconFTW 集成了30个工具的信息收集利器 | https://github.com/six2dez/reconftw | 2026-08-27 |
...
| 项目简介 | 项目地址 | 最近更新 |
| ------------------------------------------------------------ | ---------------------------------------------------- | --- |
| 开源的跨平台对手仿真/红队框架 | https://github.com/BishopFox/sliver | 2026-08-30 |
